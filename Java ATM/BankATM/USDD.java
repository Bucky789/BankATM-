...
public class USDD extends JFrame {
	/**
	 * 
	 */
	...
	static float usd=(DepositInt.a)*81;
	...
	public USDD() {
		...
		JLabel lblNewLabel = new JLabel("Entered Amount in INR is : ₹"+String.format("%.2f", usd));
		lblNewLabel.setFont(new Font("Segoe UI", Font.BOLD, 35));
		lblNewLabel.setBounds(10, 80, 684, 107);
		...
		lblNewLabel_1.setBounds(89, 278, 525, 41);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					st.executeUpdate("insert into transactions (accno,type,amount,balance,date) values("+GUI.accountno+",'Deposit',"+usd+","+(GUI.balance+usd)+",curdate())");
					st.executeUpdate("update account set balance="+(GUI.balance+usd)+" where accno="+GUI.accountno);
