...
public class CADD extends JFrame {
	...
	public CADD() {
		...
		JLabel lblNewLabel = new JLabel("Entered Amount in INR is : ₹"+String.format("%.2f", cad));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					st.executeUpdate("insert into transactions (accno,type,amount,balance,date) values("+GUI.accountno+",'Deposit',"+cad+","+(GUI.balance+cad)+",curdate())");
					st.executeUpdate("update account set balance="+(GUI.balance+cad)+" where accno="+GUI.accountno);
